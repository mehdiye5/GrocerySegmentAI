	...
	<div class="page-wrapper toggled light-theme">
        <nav id="sidebar" class="sidebar-wrapper">
            <div class="sidebar-content">
                <!-- sidebar-brand  -->
                <div class="sidebar-item sidebar-brand text-white font-weight-bold"><i class="fa fa-database"></i><h3 style="padding-left:10px">GrocerySegmentAI Service Service</h3></div>
                <!-- sidebar-header  -->
                <!-- sidebar-search  -->
            ...
            <div class="container-fluid">
                ...
                <div class="row p-lg-4">
                    <article class="main-content col-md-9 pr-lg-5">
                        ...
                        <h1 class="mb-2 mt-3">Create GrocerySegmentAI Data Object</h1>
                        <!--//title -->
                        <p class="lead mb-3"> How to get started with GrocerySegmentAI </p>
                        <p>This service was brought to you by the DiversiT team.</p>
                        
                        <p> In this page you will need to create GrocerySegmentAI data objects. To create data objects you need provide AWS S3 <strong>Bucket name</strong> and <strong>Obeject Key</strong>. Once that is done, GrocerySegmentAI will pull the data files from the S3 bucket and convert the files to the data objects. There are 3 categories of data objects <strong>Orders, Products and Order_Products</strong>. Orders data object is derived from a orders data file that you have provided. This file must contain the list of orders that you wish the Istacart to analyze. Similar idea applies to Products and Order_Products files</p>
                        <div class="alert alert-primary d-flex justify-content-start align-items-center" role="alert"> <span class="fa fa-info mr-4"></span>
                            <p class="m-0"><strong>Important*</strong> Please note that the data files uploaded to the AWS S3 bucket will need to be in <strong>.csv</strong> format</p>
                        </div>
                        <!-- Sep -->
                        <hr class="my-5">
                        <!-- alert -->
                        ...
                        <div class="col-md-6">
				                    <div class="box-for overflow">
				                        <div class="col-md-12 col-xs-12 register-blocks">
				                            <h2>New GrocerySegmentAI Data Object : </h2> 
				                            <form action="ReadS3Data" method="GET">
				                                ...
				                                <div class="form-group">
				                                    <label for="email">AWS S3 Product Bucket Name</label>
				                                    <input type="text" class="form-control" id="product_bucket_name" name="product_bucket_name">
				                                </div>
				                                <div class="form-group">
				                                    <label for="password">AWS S3 Product Folder Name</label>
				                                    <input type="text" class="form-control" id="product_bucket_key" name="product_bucket_key">
				                                </div>
				                                
				                                <hr class="my-5">
				                                
				                                <div class="form-group">
				                                    <label for="email">AWS S3 Orders Bucket Name</label>
				                                    <input type="text" class="form-control" id="product_bucket_name" name="orders_bucket_name">
				                                </div>
				                                <div class="form-group">
				                                    <label for="password">AWS S3 Orders Folder Name</label>
				                                    <input type="text" class="form-control" id="product_bucket_key" name="orders_bucket_key">
				                                </div>
				                                
				                                <hr class="my-5">
				                                
				                                <div class="form-group">
				                                    <label for="email">AWS S3 Product Orders Bucket Name</label>
				                                    <input type="text" class="form-control" id="product_orders_bucket_name" name="product_orders_bucket_name">
				                                </div>
				                                <div class="form-group">
				                                    <label for="password">AWS S3 Product Orders Folder Name</label>
				                                    <input type="text" class="form-control" id="product_orders_bucket_key" name="product_orders_bucket_key">
				                                </div>
